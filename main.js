...
const postsListContainer = document.getElementById("container");

posts.forEach((post) => {
  console.log(post);
  const newPost = createSinglePost(post); // Elemento HTML
  postsListContainer.append(newPost);
});

/**La funzione che crea un elemnto che rappresenta un post
 * @param {object} post
...
// NON pure function
/**
 * Ritorna true se id del post è nell'array dei likedPosts, false atrimenti
 * @returns {boolean}
 */
